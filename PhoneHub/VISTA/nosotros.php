        ...
        <div class="container-fluid">                          
            ...
            <div class="row bg-body-secondary">                        <!--LOGO-->
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu bg-body-secondary">
                            <li class="d-flex flex-row justify-content-center">
                                <button class="btn btn-outline-dark border border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#perfil_responsive" aria-controls="offcanvasRight">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-person m-1" viewBox="0 0 16 16">
                                        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
                                    </svg>
                                </button>
                                <button class="btn btn-outline-dark border border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#favoritos_responsive" aria-controls="offcanvasRight">
                            ...
                            <li><a class="dropdown-item text-dark" href="home.php">Home</a></li>
                            <li><a class="dropdown-item text-dark" href="tienda.php">Tienda</a></li>
                            <li><a class="dropdown-item text-dark" href="nosotros.php">Nosotros</a></li>
                            <li><a class="dropdown-item text-dark" href="contacto.php">Contacto</a></li>  
                        </ul>
                    </div>
                ...
                <div class="col d-flex justify-content-center justify-content-lg-start">
                    <img class="img-fluid  p-3" style="width: 20em;" src="../img/PhoneHub_Logo2-fotor-2023102312412.png"> 
                </div>
        ...
        <div class="container-fluid">
            <div class="row p-2">
                ...
                <div class="col d-flex justify-content-center">
                   <a class=" fw-lighter fs-5 nav"  href="home.php">HOME</a>
                </div>

                <div class="col d-flex justify-content-center">
                    <a class=" fw-lighter fs-5 nav"  href="tienda.php">TIENDA</a>

                </div>

                <div class="col d-flex justify-content-center">
                    <a style="color: yellowgreen;" class=" fw-lighter fs-5"  href="nosotros.php">NOSOTROS</a>
                </div>

                <div class="col d-flex justify-content-center">
                    <a class=" fw-lighter fs-5 nav"  href="contacto.php">CONTACTO</a>
                </div>
    ...
    <div id="caracteristicas" class="container-fluid">
        ...
        <div class="row p-4">
            <div class="col-12 col-md m-2 p-5">
                <div class="row p-2">
                    <div class="col text-center fs-3 fst-italic">
                        ...
                        Variedad de teléfonos y marcas líderes:
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col p-2 text-center">
                        Ofrecemos una amplia gama de teléfonos móviles de las marcas más reconocidas, lo que te permite encontrar el dispositivo perfecto que se adapte a tus necesidades, ya sea para trabajo o entretenimiento.
                    </div>
                </div>
            </div>
            <div class="col m-2 p-5">
                <div class="row p-2">
                    <div class="col text-center fs-3 fst-italic">
                        ...
                        Accesorios y servicios de calidad:
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col text-center">
                       Contamos con servicios de reparación y mantenimiento de alta calidad para garantizar que tu dispositivo funcione de manera óptima en todo momento.
                    </div>
                </div>
            </div>
            <div class="col-12  col-xl m-2 p-5">
                ...
                <div class="row p-2">
                    <div class="col text-center">
                        Nuestro equipo de expertos está aquí para brindarte asesoría personalizada. Ya sea que necesites ayuda para elegir el dispositivo adecuado o resolver problemas técnicos, estamos comprometidos en brindarte la mejor orientación y soluciones.
                    </div>
                </div>
            </div>
        </div>
            <div class="row mb-5">
                <div class="col-xs-12 col-md  m-2 p-5">
                    ...
                    <div class="row p-2">
                        <div class="col text-center">
                            Nuestro compromiso es superar tus expectativas en términos de atención al cliente. Queremos que tengas una experiencia de compra sin igual, donde tus necesidades son nuestra máxima prioridad.
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-md m-2 p-5">
                    ...
                    <div class="row p-2">
                        <div class="col text-center">
                            Nuestra tienda ofrece precios competitivos en dispositivos móviles y servicios. Además, constantemente presentamos ofertas especiales, que incluyen descuentos en combinaciones de teléfonos y planes, así como atractivos paquetes de accesorios.
                        </div>
                    </div>
                </div>
