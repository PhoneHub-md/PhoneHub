...
<header>
    <div class="container-fluid">
        <div class="row fondo_3 text-white"> <!--BARRA TELEFONOS-->
            ...
            <div class="col-5 col-lg-4 col-xl-3  d-none d-md-flex flex-row align-items-center ">
            ...
            <div class="col-5 col-md-4 d-flex flex-row align-items-center  justify-content-start">
                        ...
                        <div class="modal-content bg-secondary bg-opacity-25 rounded">
                            ...
                            <div class="modal-header d-flex align-items-center justify-content-center">
                                <div class="col-8 d-flex justify-content-end">
                                    <span style="text-shadow: black 0.1em 0.1em 0.2em" class="fs-2 text-white fw-semibold">REGISTRAR</span>
                                </div>
